...
// forward reference to configuration data array
extern const std::array<uint8_t, 8192> imu_bmi270_config_data;
...
IMU_BMI270::IMU_BMI270(axis_order_e axisOrder, uint32_t frequency, BUS_BASE::bus_index_e SPI_index, const BUS_SPI::pins_t& pins) :
    IMU_Base(axisOrder, _bus),
    _bus(frequency, SPI_index, pins)
{
}
#else
IMU_BMI270::IMU_BMI270(axis_order_e axisOrder, BUS_BASE::bus_index_e I2C_index, const BUS_I2C::port_pins_t& pins, uint8_t I2C_address) :
    IMU_Base(axisOrder, _bus),
    _bus(I2C_address, I2C_index, pins)
{
}
IMU_BMI270::IMU_BMI270(axis_order_e axisOrder, BUS_BASE::bus_index_e I2C_index, const BUS_I2C::pins_t& pins, uint8_t I2C_address) :
    IMU_Base(axisOrder, _bus),
    _bus(I2C_address, I2C_index, pins)
{
}
...
xyz_t IMU_BMI270::readGyroRPS()
{
    return readAccGyroRPS().gyroRPS;
}

xyz_t IMU_BMI270::readGyroDPS()
{
    return readAccGyroRPS().gyroRPS * radiansToDegrees;
}

xyz_t IMU_BMI270::readAcc()
{
...
/*!
As described in section 4.4 Power-On Reset (POR) and Device Initialization of BMI270 datasheet
configuration data taken from https://github.com/boschsensortec/BMI270_SensorAPI/blob/master/bmi270.c#L51
*/
namespace {
const std::array<uint8_t, 8192> imu_bmi270_config_data = {
